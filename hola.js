...
function inicialitzaJoc() {
    ...
    let nMines = document.getElementById("minasC").valueAsNumber;
    let cx = document.getElementById("inputX").valueAsNumber;
    let cy = document.getElementById("inputY").valueAsNumber;
